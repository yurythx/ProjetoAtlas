      ...
      <div className="rounded-[2.5rem] border border-white/10 bg-white/5 backdrop-blur-xl p-8 shadow-2xl relative overflow-hidden group/header">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 relative z-10">
          <div className="space-y-1">
            <h3 className="text-2xl font-black tracking-tighter uppercase">Tabela Operacional de Alta Precisção</h3>
            <p className="text-xs font-bold text-muted-foreground/60 uppercase tracking-widest">
              Fluxo Analítico de Oportunidades â€¢ <span className="text-primary">{pipeline.name}</span>
            </p>
          </div>
          <div className="flex items-center gap-3">
